...
set "SOURCE_PATH=C:\\Users\\88691\\AppData\\Local\\Temp\\arduino\\sketches\\226B9559E604CDB5D089934E8D797676\SailBoardPolit.ino.elf"

:: Set the destination folder (where the .ino file is located)
set "DEST_FOLDER=F:\PHD\Arduino_Projects\SailBoardPolit\SailBoardPolit_v16.0"
